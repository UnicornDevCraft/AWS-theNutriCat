...
searchModal.addEventListener('show.bs.modal', () => {
    ...
    const searchButton = document.querySelector("#searchModal .btn.btn-primary");
    const recipesApiUrl = document.getElementById("recipes-api-url").value;
